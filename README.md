...
I build scalable web products end-to-end from database architecture to the last pixel on the frontend. My stack of choice is NestJS, Next.js, Prisma, and PostgreSQL, and I care as much about what happens under the hood as I do about what ships to users.

Currently studying Computer Engineering at Obafemi Awolowo University while working on production systems that handle real data for real people.
